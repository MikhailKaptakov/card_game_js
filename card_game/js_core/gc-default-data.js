...
GAME_CORE.DEFAULT_PROPS.rarityOptions = [
    ...
    new GAME_CORE.RarityOption('common', 35000, 'commonCard', 'comm.',
        'обычный', 'grey', new GAME_CORE.Price(100,25), new GAME_CORE.BaseStatMap(50,5,5,2)),
    new GAME_CORE.RarityOption('uncommon', 40000, 'uncommonCard', 'uncom.',
        'необычный', 'blue', new GAME_CORE.Price(200,50), new GAME_CORE.BaseStatMap(100,10,10,4)),
    new GAME_CORE.RarityOption('rare', 45000, 'rareCard', 'rare.',
        'редкий', 'yellow', new GAME_CORE.Price(500,125), new GAME_CORE.BaseStatMap(150,15,15,6)),
    new GAME_CORE.RarityOption('epic', 47500, 'epicCard', 'epic',
       'эпический', 'blueviolet', new GAME_CORE.Price(1000,250), new GAME_CORE.BaseStatMap(200,20,20,8)),
    new GAME_CORE.RarityOption('legendary', 50000, 'legendaryCard', 'legend.',
        'легендарный', 'orange', new GAME_CORE.Price(1500,375), new GAME_CORE.BaseStatMap(250,25,30,10)),
    new GAME_CORE.RarityOption('mythical', 52500, 'mythicalCard', 'mythic.',
        'мифический', 'pink', new GAME_CORE.Price(2000,500), new GAME_CORE.BaseStatMap(300,30,40,12)),
    new GAME_CORE.RarityOption('divine', 55000, 'divineCard', 'divine',
        'божественный', 'aqua', new GAME_CORE.Price(4000,1000), new GAME_CORE.BaseStatMap(350,35,50,14)),
    new GAME_CORE.RarityOption('ancient', 80000, 'ancientCard', 'ancient',
        'древний', 'rgb(100,191,100,1)', new GAME_CORE.Price(8000,2000), new GAME_CORE.BaseStatMap(400,40,60,16)),
    new GAME_CORE.RarityOption('hell', 80000, 'hellCard', 'hell',
        'адский', 'rgb(255,0,0,1)', new GAME_CORE.Price(12000,3000), new GAME_CORE.BaseStatMap(500,50,80,20)),
    new GAME_CORE.RarityOption('star', 80000, 'starCard', 'StaR',
        'звездный', 'rgb(255,255,0,1)', new GAME_CORE.Price(16000,4000), new GAME_CORE.BaseStatMap(600,60,120,24))
];
